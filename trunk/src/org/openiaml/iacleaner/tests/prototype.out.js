...
/* Based on Alex Arnell's inheritance implementation. */ var Class = {
  create: function() {
...
if (Prototype.Browser.Opera) {
  Element.Methods.getStyle = Element.Methods.getStyle.wrap( function(proceed, element, style) {
    switch (style) {
      ...
      case 'height': case 'width': // returns '0px' for hidden elements; we want it to return null
...
// test here
if (!Prototype.BrowserFeatures.ElementExtensions && // test here
 //
 // test here
 window.HTMLElement = {
};
 ...
 * license.  Please see http://www.yui-ext.com/ for more information. */ var Selector = Class.create({
 ...
 if (Prototype.Browser.WebKit) {
  ...
  (function() {
    /* Support for the DOMContentLoaded event is based on work by Dan Webb,
     Matthias Miller, Dean Edwards and John Resig. */ var timer;
  ...
  /*------------------------------- DEPRECATED -------------------------------*/ Hash.toQueryString = Object.toQueryString;
  var Toggle = {
