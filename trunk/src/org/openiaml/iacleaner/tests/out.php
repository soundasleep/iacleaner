<?php /* generated page "viewkey" */ // include header code
 session_start();
$log_unique_id = sprintf("%04x", rand(0,0xffff));
function log_message($msg, $also_debug = true) {
  global $log_unique_id;
  $msg = "[$log_unique_id] $msg";
  // append a unique ID to help us track requests
 $fp = fopen("php.log", "a");
...
// ensure DB exists
 ...
 do_model_11e47202c05_19( /* a property from our session */ require_session("model_11e37b8d89c_17") );
// expand any operations (both in this page and in any surrounding scopes)
 ...
 /** composite operation "update" */ $running_model_11e47202c05_28 = false;
function do_model_11e47202c05_28( $model_11e47202c05_2b) {
 ...
 global $running_model_11e47202c05_28;
  if ($running_model_11e47202c05_28 == false) {
    $running_model_11e47202c05_28 = true;
    // prevent loops
...
/** composite operation "check key" */ $running_model_11e47202c05_19 = false;
function do_model_11e47202c05_19( $model_11e47202c05_1a) {
 ...
 global $running_model_11e47202c05_19;
  if ($running_model_11e47202c05_19 == false) {
    $running_model_11e47202c05_19 = true;
    // prevent loops
 // has this operation got a fail handler?
...
<html>
  <head>
   ...
   not available on the current page */ function store_event(page_id, event_name, arg0) {
 ...
 debug("something went wrong: " + transport.responseText);
            $('ajax_monitor').innerHTML = 'failed: ' + response.responseText;
            // for speeding up testing
 alert('Something went wrong...');
          // alert is last so we can continue execution
 }
        });
        debug("store_event called");
      }
      /* save directly to database (only one attribute) */ function store_db(attribute_id, arg0) {
 ...
 alert('Something went wrong...');
      ...
      /* save a session variable (only one attribute) */ function set_session(id, arg0, function_queue) {
 ...
 */ function IamlJavascriptException(message) {
        ...
        this.toString = function() {
          return "IamlJavascriptException: " + message;
        }
      }
      // ---------
 /**
 ...
 */ function createCookie(name,value,days) {
      ...
      /* page onload functions */ populateFields();
    </script>
    <script language="Javascript">
      var try_catch_depth = 0;
      // expanding operations for org.openiaml.model.model.visual.impl.PageImpl@15c0d33 (isGenerated: false, id: visual.11e37b8d948.d, name: viewkey, overridden: false) (url: null)
 /** composite operation "update" */ var running_model_11e47202c05_28 = false;
      function do_model_11e47202c05_28( model_11e47202c05_2b) {
        // operation: update
 if (running_model_11e47202c05_28 == false) {
          running_model_11e47202c05_28 = true;
 ...
 if (!function_queue_queued) function_queue();
      ...
      /** composite operation "check key" */ var running_model_11e47202c05_19 = false;
      function do_model_11e47202c05_19( model_11e47202c05_1a) {
        // operation: check key
 if (running_model_11e47202c05_19 == false) {
          running_model_11e47202c05_19 = true;
 ...
 if ( is_array_equal(new Array( model_11e47202c05_1a, "42" )) ) {
                // passed (exactly one pass)
 // do nothing org.openiaml.model.model.operations.impl.FinishNodeImpl@1f33149 (isGenerated: true, id: operations.11e47202c63.9)
 }
                else {
 ...
 var url = "visual_11e47202c63_4.php?fail=" + e;
            /* TODO urlencode me */ debug("Redirecting to '" + url + "' (fail)");
            window.location = url;
          }
          running_model_11e47202c05_19 = false;
        }
      }
      /** composite operation "do logout" */ var running_model_11e47202c05_20 = false;
      function do_model_11e47202c05_20() {
        // operation: do logout
 if (running_model_11e47202c05_20 == false) {
          running_model_11e47202c05_20 = true;
 ...
 // chained operation setPropertyToValue		
 // outFlows first to = org.openiaml.model.model.impl.ApplicationElementPropertyImpl@13641d6 (isGenerated: false, id: model.11e37b8d89c.17, name: my login key, defaultValue: null)
 set_session("model_11e37b8d89c_17", "null" /* static value "model_11e47202c05_21" */ , function_queue);
              // pass it a function queue to execute afterwards
 function_queue_queued = true;
              // we are waiting for it to return to execute the function queue
 // do nothing org.openiaml.model.model.operations.impl.FinishNodeImpl@cedf4e (isGenerated: true, id: operations.11e47202c63.c)		
 // should we still run the chained functions?
 if (!function_queue_queued) function_queue();
            }
...
log_message("deleting all events for page visual.11e37b8d948.d");
  ...
  <body onLoad="loadStoredEvents()">
    <div style="font-size:small; text-align: right;"><a href="clear_session.php">clear session</a>
    - <a href="sitemap.html">sitemap</a></div>
    <h1>viewkey</h1>
    <div id="runtime_errors"><!-- any runtime errors go into here --></div>
    <?php /* expand any fail error messages */ if (require_get("fail")) {
      ?>
      <div class="error">
        <p>An exception occured: <i><?php echo htmlspecialchars(require_get("fail"));
        ?></i></p>
      </div>
    <?php }
    ?>
    <div>
      ...
      current login key <input type="text" id="visual_11e37df5bce_1c" name="visual_11e37df5bce_1c" onChange=" return false;" >
      </label>
    </div>
    <div id="debug">
      <div>
